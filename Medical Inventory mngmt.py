...
mydb = mysql.connector.connect(host="localhost", user="root", password="Chandu@30")
cr = mydb.cursor()
...
# setting conection
mydb = sql.connect(host="localhost", user="root", password="Chandu@30", database="medicine_shop")
